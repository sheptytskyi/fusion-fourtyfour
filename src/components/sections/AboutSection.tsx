      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-16 items-stretch mb-12 md:mb-16">
          ...
          <div ref={imageRef} className="relative lg:col-span-3 flex">
            <div className="relative w-full h-full rounded-glass overflow-hidden glass">
              <img 
               src="/team.webp"
                alt="44 Fingers Team"
          ...
          <div ref={contentRef} className="space-y-6 md:space-y-8 lg:col-span-2">
            <div>
              ...
              <p className="text-base md:text-lg lg:text-s font-jetbrains font-light text-light-fg/70 leading-relaxed">
              We help businesses build digital products that actually make sense.
              </p>
              <p className="text-base md:text-lg lg:text-s font-jetbrains font-light text-light-fg/70 leading-relaxed mt-3 md:mt-4">
